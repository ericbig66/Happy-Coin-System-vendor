...
public class vender_send_redbag extends AppCompatActivity {
    ...
    public void getCode(View v) {
        ...
        if(amount.getText().toString().trim().isEmpty() || Integer.parseInt(amount.getText().toString().trim())<1){Toast.makeText(vender_send_redbag.this,"請輸入紅包金額",Toast.LENGTH_LONG).show();}
        else{
