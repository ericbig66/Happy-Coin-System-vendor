...
public class recent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_recent);
//        entryIsRecent = true;
    ...
    private class ConnectMySql extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(recent.this, "請稍後...", Toast.LENGTH_SHORT).show();
        }
        ...
        protected String doInBackground(String... strings) {
            if (function == 0) {
                try {
                    ...
                    ResultSet rs = st.executeQuery("select * from activity where actDate> curDate()");
        ...
        protected void onPostExecute (String result){
            try {
                if (function == 0) {
                    ...
                    Toast.makeText(recent.this, result, Toast.LENGTH_SHORT).show();
...
//        price.setText("時間:"+AactDate.get(ID).toString().substring(2));
...
//            else{buybtn.setText("參加");}
    ...
    public void identifier(String act, int ID, int quantity) {
        ...
        if (act.equals("D")) {
            ...
            Intent intent = new Intent(recent.this, add_activity.class);
            ...
            if(quantity>0) {
                ...
                Toast.makeText(recent.this,"請至少新增一個名額",Toast.LENGTH_SHORT).show();
            }
